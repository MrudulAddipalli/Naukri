...
class CandidateAppliedJobs extends StatefulWidget {
  @override
  CandidateAppliedJobsState createState() => CandidateAppliedJobsState();
}

class CandidateAppliedJobsState extends State<CandidateAppliedJobs> {
  var jobProvider;
  ...
  getJobDetails() async {
    Map<String, dynamic> response =
        await jobProvider.getAllCandidateAppliedJobs();
