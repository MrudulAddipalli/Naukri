...
class RecruiterAllJobs extends StatefulWidget {
  @override
  RecruiterAllJobsState createState() => RecruiterAllJobsState();
}

class RecruiterAllJobsState extends State<RecruiterAllJobs> {
  var jobProvider;
